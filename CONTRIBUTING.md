# Contribute to `yardstiq`

`yardstiq` is Apache 2.0 licensed and accepts contributions via GitHub.
...
- The version of `yardstiq` you are using
- Python version
...
- Does this align with the goals of `yardstiq`?
...
- Open a pull request against `yardstiq` master branch that follows [PR guidelines](#pull-request-guidelines)

The maintainers of `yardstiq` use a "Let's Get This Merged" (LGTM) message in the pull request to note that the commits are ready to merge.
